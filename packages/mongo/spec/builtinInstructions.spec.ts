import { FieldCondition, CompoundCondition, FieldInstruction, DocumentCondition, ITSELF } from '@ucast/core';
...
describe('Built-in instructions', () => {
  ...
  describe('$not', () => {
    ...
    it('throws if value is undefined, not a RegExp or not a POJO', () => {
      expect(() => parser.parse<any>({ field: { $not: 1 } })).to.throw(/expects to receive either regular expression or object of field operators/);
      expect(() => parser.parse<any>({ field: { $not: null } })).to.throw(/expects to receive either regular expression or object of field operators/);
      expect(() => parser.parse<any>({ field: { $not: [] } })).to.throw(/expects to receive either regular expression or object of field operators/);
    })
  })
  ...
  describe('$elemMatch', () => {
    ...
    it('throws if passed value is not an object', () => {
      expect(() => parser.parse({ a: { $elemMatch: 1 } })).to.throw(/expects to receive an object/)
      expect(() => parser.parse({ a: { $elemMatch: [] } })).to.throw(/expects to receive an object/)
      expect(() => parser.parse({ a: { $elemMatch: null } })).to.throw(/expects to receive an object/)
    })
  })
  ...
  describe('$size', () => {
    ...
    it('throws if passed value is not a number', () => {
      expect(() => parser.parse({ a: { $size: 'test' } })).to.throw(/expects value to be a "number"/);
      expect(() => parser.parse({ a: { $size: null } })).to.throw(/expects value to be a "number"/);
      expect(() => parser.parse({ a: { $size: [] } })).to.throw(/expects value to be a "number"/);
    })
  })
  ...
  describe('$mod', () => {
    ...
    it('throws if passed not an array or array length does not equal 2', () => {
      expect(() => parser.parse({ a: { $mod: [] } })).to.throw(/expects an array with 2 numeric elements/)
      expect(() => parser.parse({ a: { $mod: [1] } })).to.throw(/expects an array with 2 numeric elements/)
      expect(() => parser.parse<any>({ a: { $mod: null } })).to.throw(/expects an array with 2 numeric elements/)
      expect(() => parser.parse<any>({ a: { $mod: 1 } })).to.throw(/expects an array with 2 numeric elements/)
    })
  })
  ...
  describe('$exists', () => {
    ...
    it('throws if passed not a boolean', () => {
      expect(() => parser.parse({ a: { $exists: [] } })).to.throw(/expects value to be a "boolean"/)
      expect(() => parser.parse({ a: { $exists: null } })).to.throw(/expects value to be a "boolean"/)
      expect(() => parser.parse({ a: { $exists: {} } })).to.throw(/expects value to be a "boolean"/)
    })
  })
  ...
  describe('$regex', () => {
    ...
    it('throws if passed not a string or RegExp', () => {
      expect(() => parser.parse({ a: { $regex: [] } })).to.throw(/expects value to be a regular expression or a string/)
      expect(() => parser.parse({ a: { $regex: null } })).to.throw(/expects value to be a regular expression or a string/)
      expect(() => parser.parse({ a: { $regex: {} } })).to.throw(/expects value to be a regular expression or a string/)
    })
  })
